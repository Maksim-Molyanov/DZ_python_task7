...
phrases = text.split()
count_vowel_first = list(map(lambda ch: ch in "ёуеыаоэяиюЁУЕЫАОЭЯИЮ", phrases[0])).count(True)
result = "Парам пам-пам"
for phrase in phrases:
    if list(map(lambda ch: ch in "ёуеыаоэяиюЁУЕЫАОЭЯИЮ", phrase)).count(True) != count_vowel_first:
        result = "Пам парам"
print(result)